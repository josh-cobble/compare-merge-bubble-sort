...
public class mergecomparebubble {
...
public static void main(String[] args) {
    ...
    System.out.println("\nThese numbers will be randomly generated and then sorted from smallest to largest using Bubblesort and Mergesort.");
    System.out.println("The time it took each array to be sorted will appear below each array in nanoseconds.");
    System.out.println("Note that your unsorted array will be stored to the 'storearray.txt' file and the sorted one will be stored to 'bubblesort.txt'");
    System.out.println("and 'mergesort.txt'.\n");
